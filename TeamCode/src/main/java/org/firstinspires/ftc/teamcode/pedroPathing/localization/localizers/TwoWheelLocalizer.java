...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.00297;
    public static double STRAFE_TICKS_TO_INCHES = 0.00297;
    /**
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frd"));
