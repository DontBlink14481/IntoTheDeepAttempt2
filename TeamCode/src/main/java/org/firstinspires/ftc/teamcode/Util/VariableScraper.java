...
public class VariableScraper {
    ...
    public static HashMap<String, String> getAllVariables(Class<?> classObj, Object obj, boolean showStatic) {
    ...
    /*public void writeVariablesToTelemetry(Telemetry t) {
        HashMap<String, String>> vars = getAllVariables();
